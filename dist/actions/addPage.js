...
function default_1(name) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            const { comType } = yield inquirer_1.default.prompt([inquirers_1.comTypeQues]);
            const tplPath = path_1.join(__dirname, '../../templates/componentTpl', comType);
            ...
            console.log(chalk_1.default.green('创建成功>>', comType));
        }
        catch (e) {
